            ...
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    if (document.documentElement.classList.contains("sub-menu-open")) {
                        ...
                        document.querySelector(".sub-menu-catalog__block").classList.remove("_sub-menu-open");
                    }
                }
            }));
        }
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                nouislider.create(item, {
                    ...
                    tooltips: [ true, true ],
                    range: {
                        min: [ parseInt(fromValue.dataset.rangeFrom) ],
                        max: [ parseInt(toValue.dataset.rangeTo) ]
                    }
                });
